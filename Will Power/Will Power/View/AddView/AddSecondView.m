...
@interface AddSecondView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
-(UIView *)forPicker_view_start{
    if (!_forPicker_view_start) {
        _forPicker_view_start=[[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT*0.45)];
...
-(UIView *)forPicker_view_repeat{
    if (!_forPicker_view_repeat) {
        _forPicker_view_repeat=[[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT*0.45)];
...
-(UIView *)forPicker_view{
    if (!_forPicker_view) {
        _forPicker_view=[[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT*0.45)];
