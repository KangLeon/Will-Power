...
-(DayView*)dayView{
    if (!_dayView) {
        _dayView=[[DayView alloc] initWithFrame:CGRectMake(self.repeatDay_label.frame.size.width+SCREEN_WIDTH*0.012077, SCREEN_HEIGHT*0.03396, SCREEN_WIDTH*0.096618, SCREEN_HEIGHT*0.02445)];
